...
<task type="auto">
  <name>Task 2: Create Bar Chart MCP App</name>
  <files>
    mcp-apps/src/bar-chart/index.html
    mcp-apps/src/bar-chart/main.tsx
    mcp-apps/src/bar-chart/BarChart.tsx
...
```
  ...
  <done>
Bar chart MCP App source exists with Recharts BarChart and ExportControls
  </done>
</task>
...
**Build all MCP Apps:**
Update mcp-apps/vite.config.ts to build all three apps:
